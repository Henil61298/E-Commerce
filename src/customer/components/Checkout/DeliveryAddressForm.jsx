                    ...
                    <Box className="border rounded-s-md shadow-md p-5">
                        <form onSubmit={handleSubmit}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} lg={6}>
                                    <TextField required id='state' name='state' label='State / Region / Province' fullWidth autoComplete='given-name'/>
                                ...
                                <Grid item xs={12} sm={6}>
                                <Button variant='contained' sx={{mt: "2", py:"1.5", bgcolor:"#9155fd"}} size='large' type='submit'>
                            Deliver Here
                        </Button>
